const languages = [
    ...
    { name: 'HTML', icon: './src/assets/icons/languages/html.png' },
    { name: 'CSS', icon: './src/assets/icons/languages/css.png' },
    { name: 'Arduino', icon: './src/assets/icons/languages/arduino.png' },
    { name: 'C', icon: './src/assets/icons/languages/c.png' },
];
